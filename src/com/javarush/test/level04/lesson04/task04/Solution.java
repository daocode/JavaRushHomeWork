...
public class Solution {
    ...
    int m = mount/3;
        if (m == 0) System.out.println("зима");
        if (m == 1) System.out.println("весна");
        if (m == 2) System.out.println("лето");
        if (m == 3) System.out.println("осень");
        if (m == 4) System.out.println("зима");
